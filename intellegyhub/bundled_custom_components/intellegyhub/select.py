...
from .const import DOMAIN, XPORT_MODES
...
class IntellegyHubXPortModeSelect(IntellegyHubXPortEntity, SelectEntity):
    ...
    def current_option(self) -> str | None:
        return self.channel_state.get("confirmed_mode")

    async def async_select_option(self, option: str) -> None:
        await self.manager.async_set_xport_mode(self.channel, option)
